...
import { 
  Plus, Search, PenLine, Trash, Pin, PinOff, RotateCcw, Trash2, Settings, Sun, Moon, Palette 
} from 'lucide-react';
        ...
        <div ref={settingsRef}>
          ...
          {settingsOpen && (
            <div className={`absolute bottom-12 right-0 w-56 border rounded-lg shadow-2xl py-2 z-50 animate-in ${theme === 'dark' ? 'bg-[#0a0a0a] border-[#1f1f1f]' : 'bg-white border-zinc-200'}`}>
              ...
              <div className="mx-4 my-2 border-t pt-3 flex flex-col gap-2 border-zinc-100">
